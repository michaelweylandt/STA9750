...
- **Peer Feedback:**
  ...
  - **Peer Feedback Due: `r mp |> filter(str_detect(Details, "Mini-Project Peer Feedback Due")) |> pull(dt)` on Brightspace**
- Estimated Return of Grades and Comments:
  - Initial Submission: 
    `r mp |> filter(str_detect(Details, "Estimated Return"), str_detect(Details, "Peer")) |> pull(dt)`
  - Meta-Review: 
    `r mp |> filter(str_detect(Details, "Estimated Return"), str_detect(Details, "Meta")) |> pull(dt)`
    
*Estimated Time to Complete: `r if(mp_id) "13-15" else "2"` Hours*
