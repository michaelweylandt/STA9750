...
Next week: Course project proposal presentations ([Official Description](../project.qmd#project-proposal-presentations))
...
- `r N_STUDENTS` Users registered via Teams Post
...
Recall that you need to submit *via* GitHub, Brightspace, and Teams for this 
...
`cissoid`: `CIS Scripts for Organizing Instructional Delivery`
...
- Due `r get_mp_deadline(01)` 
  (`r min(get_mp_deadline(01, as_date_obj=TRUE) - class_date)` Days)
- Topic: `r get_mp_title(01)`
- Analysis of Netflix Watch Time Data
- Graded out of 80
...
For this MP, you are advising Netflix on new content for the streaming service
...
- Reproducible Research Tooling (Quarto)
- Packages and Functions 
- Basic Data Manipulation (Today, `dplyr`)
- Tables for Data Display (In assignment, `gt`)
...
- `qmd` document
- Final Deliverable + supporting analysis
  - Put Deliverable at beginning or end, clearly identified
...
- Print to PDF + Submit on Brightspace (no Teams needed)

. . . 

See [general instructions](../miniprojects.qmd##mini-project-formatting) for
additional advice
...
![](../images/penguin_species.png){width="60%" fig-align="center"}

---

Artwork by `@allison_horst`

![](../images/penguin_measurements.png){width="50%" fig-align="center"}
...
![](https://jgoode.com/wp-content/uploads/2009/12/vitruvian-man-penguin.jpg){fig-align="center"}
...
```{r}
#| echo: true
# Instead of penguins |> filter(body_mass == max(body_mass, na.rm=TRUE))
...
```{r}
#| echo: true
penguins |> slice_min(body_mass, prop=0.025)
```
...
Will review after returning from breakout rooms
