...
## Special Visitor {.scrollable}

Prof. [Ann Brandwein](https://zicklin.baruch.cuny.edu/faculty-profile/ann-brandwein/) is
joining us today

![](https://zicklin.baruch.cuny.edu/wp-content/uploads/sites/10/2019/12/Ann-Cohen-Brandwein.jpg){height="200px" fig-align="center"}
...
Under [CUNY Procedures](https://psc-cuny.org/contract/article-18-professional-evaluation/), 
untenured faculty (like me!) are observed and evaluated once a semester. 
...
[CDIAC](https://web.archive.org/web/20170901063440/http://cdiac.ornl.gov/) estimates of global temperature
...
Mann, Bradley, & Hughes. *Geophysical Research Letters* 26(6). 1999.

![](https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/T_comp_61-90.pdf/page1-500px-T_comp_61-90.pdf.jpg){height="600px" fig-align="center"}
...
```{r}
#| echo: false
BREAKOUT_TABLE[["_data"]] <- BREAKOUT_TABLE[["_data"]] |>
  mutate(display = if_else(str_detect(display, "3"), paste("ACB +", display), display))
BREAKOUT_TABLE
```

## Aside: Oak Ridge

![](../images/oppenheimer_ornl.gif){height="600px" fig-align="center"}

## Calutron Girls

![](https://upload.wikimedia.org/wikipedia/commons/7/7d/%22_The_Calutron_Girls%22_Y-12_Oak_Ridge_1944_Large_Format_%2832093954911%29_%282%29.jpg){height="600px" fig-align="center"}
...
![](https://64.media.tumblr.com/618055460368eb28f228493a1ad24244/tumblr_qv7l1892cm1sgh0voo1_1280.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/3a484c7bc030ce4109bdae11b9cf8d2e/tumblr_qm8kj9BEoD1sgh0voo1_640.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/cc32a4f450a6d1960bf9b7ff1b274d32/tumblr_q8isvmN57E1sgh0voo1_1280.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/2e8a439b671e1ab092a862ee09bfb4f3/tumblr_q8q6uu5FGa1sgh0voo1_1280.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/dd3b99ccbaec2d7e16fd752912bfbe38/tumblr_oi79u8H5cG1sgh0voo1_1280.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/f6e406879ff19fff195dbb529e80f3aa/tumblr_qfeb9gSlU41sgh0voo1_1280.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/2c3170def5f3d7ebd6ea403a2931464c/tumblr_oxm9f1VBht1sgh0voo1_1280.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/fd2be427c6794cc8e25bc23c42da73aa/tumblr_omvcm7m9va1sgh0voo1_1280.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/282d910291fd14d4a36c4b5b2174553d/2c8df8348c39cc13-ac/s1280x1920/c4ef54bbf4df92f7ab215eaa92bf4fa09b439ae5.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/a937c9fdc10e2a880c85a08349d56998/tumblr_qf0idiOVVJ1sgh0voo1_1280.pnj){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/db84958c0234e3a9985e43ebdffad887/tumblr_ovyr7jaDq61sgh0voo1_1280.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/7fbfeacf7649b5d16ad4e938c040a6b1/tumblr_p79fyvl1id1sgh0voo1_1280.jpg){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/0750d78170483b7e109419ab020b8b1d/tumblr_q69w7vIOqG1sgh0voo1_1280.pnj){height="550px" fig-align="center"}
...
![](https://64.media.tumblr.com/5edb95ec3827adaac11c7544f9225840/tumblr_qjdc5wHQII1sgh0voo1_1280.pnj){height="550px" fig-align="center"}
...
![](https://d33v4339jhl8k0.cloudfront.net/docs/assets/588089eddd8c8e484b24e90a/images/6059aac6207e3b1188e1ef8a/file-g9K5yKbS9Q.png)
...
![](../images/gelman_cover.jpg){height="600px"}
...
![](../images/gelman_regr.png){height="200px"}
...
From [WSJ 2016](https://graphics.wsj.com/time-use/): 

<iframe src="https://graphics.wsj.com/time-use/" height="400px" width="800px" ></iframe>

(Remember, you get [free WSJ subscription](../resources.qmd#additional-baruch-and-cuny-benefits) as a Baruch student)
...
- _Visualization_ to find outliers and trends (today!)
...
```{r}
#| echo: false
dplyr::glimpse(read_csv("data/mp02/atusact_0324.dat"))
```

## MP#02 Files {.scrollable}

Respondent Data File

```{r}
#| echo: false
dplyr::glimpse(read_csv("data/mp02/atusresp_0324.dat"))
```
...
```{r}
#| echo: false
dplyr::glimpse(read_csv("data/mp02/atusrost_0324.dat"))
```
...
```{r}
#| echo: false
dplyr::glimpse(read_csv("data/mp02/atus_activity_codes.csv"))
```
...
See [Project Instructions](../project.qmd#mid-semester-check-in-presentations)
for more details and rubric
