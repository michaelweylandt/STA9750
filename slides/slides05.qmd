...
2. `Quarto` depends on file structure for organizing content. The main
   directory (`STA9750-2024-FALL`) should hold all of your input files. 
   You should never directly put anything in the `docs/` folder. That's
   where generated output should live. 
