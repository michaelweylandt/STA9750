...
if(file.exists("roster.json")){
    N_STUDENTS <- read_yaml("_teaching.yml")$gradedir |>
...
- [Pre-Assignment #0`r next_session`](../pre/pa04.html) due `r get_pa_deadline(session + 1)`
- [Mini-Project #00](../mini/mini00.html) due
- [Mini-Project #00](../mini/mini00.html) peer feedback
  assigned `r get_mp_pf_assigned(0)`
- [Mini-Project #01](../mini/mini01.html) released on `r get_mp_assigned(1)`
