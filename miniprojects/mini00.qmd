...
website:
  ...
  description:
    Course Projects for STA9750 at Baruch College
...
Replace `<GITHUB_NAME>` with your GitHub user name **without angle brackets**.
...
> `https://github.com/<GITHUB_ID>/{{< var course.repo >}}/settings/pages`
...
> `https://github.com/<GITHUB_ID>/{{< var course.repo >}}/settings#features`
...
to open a new issue. Title the issue `{{< var course.short >}} <GITHUB_ID> 
