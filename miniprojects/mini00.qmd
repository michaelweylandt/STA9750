...
`#| include: false` flag, but appears to be necessary to work around a bug in
`quarto`.[^bug] If you have other non-inline code blocks in your document, you
should be able to safely remove it. 

[^bug]: See [Bug Report and Discussion at
Github](https://github.com/quarto-dev/quarto-cli/issues/12029)
...
to open a new issue. Title the issue "{{< var course.short >}} 
<GITHUB_ID> MiniProject #{{< meta mp_num >}}" and fill in the following text for the issue: 
...
access your repository and website. If you don't do this, I may not be able to
access your graded assignments when you submit them! I will confirm that I have
your real ID verified as well.
