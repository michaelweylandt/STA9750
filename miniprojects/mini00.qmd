...
in more detail after Mini-Project #01 is complete.
...
You may want to use the [`postcards` package](https://github.com/seankross/postcards)
to build a more attractive home page. 
