...
instructor using the appropriate Brightspace quiz ("Regrade Request Form") within
48 hours of the graded assignment being returned. Note that the instructor will
regrade the assignment *de novo*, so your grade may be adjusted upwards or
downwards. Requests for re-grades after 48 hours will not be honored outside of
