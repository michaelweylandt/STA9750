...
Analysis of BLS CES Monthly Employment Statistics
...
-   Synchronous
    ...
    - GTA Office Hours: **Wednesdays 5:15-7:15pm**
...
```{r}
#| echo: false
data.frame(name = THURSDAY_TEAMS) |> 
    mutate(name = paste0(row_number(), ". ", name)) |> 
    knitr::kable(col.names="Presentation Order", 
                 row.names=FALSE, 
                 align = "l")
...
- [Pre-Assignment #0`r next_session`](../preassigns/pa11.html) due `r get_pa_deadline(next_session)`
