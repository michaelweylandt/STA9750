...
On
`{r} DATES |> filter(str_detect(Details, "Final Project Presentation")) |> pull(Date) |> format("%B %d, %Y (%A)") |> paste(collapse=" and ")`,
...
*  - []{rowspan=3} Communication & Presentation (30)
   ...
   - Tables and figures are acceptably styled for the report, but have notable
     issues. Formatting is unattractive, but legible throughout. 
     Total word count falls within 1000-3500 words. (3-4)
   - Tables and figures are well-formatted and suitably styled for the report. 
     ...
     Total word count falls within 1250-3250 words. (5-6)
   - Document uses advanced `Quarto` formatting to enhance legibility and
     ...
     the document.
     Total word count falls within 1500-3000 words. (7-8)
   - Document, figure, and table formatting is actively beneficial for legibility
     reading experience. Total word count falls within 1750-2750 words. (9-10)
*  - OQ Discussion (10)
...
locally. That is, a command like `read_csv` should be preceded by code 
