...
> ```https://YOUR_GITHUB_ID.github.io/`r yaml::read_yaml('_variables.yml')$course$repo`/mp{{< meta mp_num >}}.html```
...
> ```https://github.com/michaelweylandt/`r yaml::read_yaml('_variables.yml')$course$repo`/issues/new``` .
