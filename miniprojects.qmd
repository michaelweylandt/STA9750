...
`select`, `arrange`, `rename`) to produce summary statistics. I also provide
students with table "shapes" they need to manipulate their data to in order to
use provided `ggplot2` visualizations.
