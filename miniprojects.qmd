...
In [Mini-Project #01](./mini/mini01.qmd), students will explore Netflix's
periodic *What We Watched* reports, which provide aggregate viewing data
for (almost) all Netflix programming. Students will practice 
selecting rows and columns and aggregating data (*e.g.*, across
all time periods or across all seasons of a popular show) using
...
determine the effective programming on Netflix and to provide insights and
suggestions into Netflix's future production decisions.  
...
In [Mini-Project #02](./mini/mini02.qmd), TBD
...
In [Mini-Project #03](./mini/mini03.qmd), TBD
...
In [Mini-Project #04](./mini/mini04.qmd), TBD
