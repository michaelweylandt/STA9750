...
"parts of speech" necessary to convert tidy data to a visual representation.
...
`ggplot2`, like many of the tools in this course, does exactly what we ask, and 
...
`flipper_len` and `body_mass` have been placed on the $x$- and $y$-axes
...
Note the warning about dropping two points for missing (`NA`) values. This is 
fine and safe to ignore because we know our data has some `NA`s, but if you are
getting this in unexpected circumstances, you may want to look into it further.
...
white theme (`theme_bw()`) over the grey default: 
...
I tend to like the colors of the 
[Color Brewer](https://colorbrewer2.org/#type=sequential&scheme=BuGn&n=3)
project, though strictly speaking these are designed for use in maps, not
scatter plots. You can access these in `ggplot2` as follows: 
...
- DataCamp: "Introduction to Data Visualization with `ggplot2`" and
  "Understanding Data Visualization".
- Textbook: [*R4DS* §1](https://r4ds.hadley.nz/data-visualize.html) 
  and [*R4DS* "Visualize"](https://r4ds.hadley.nz/visualize.html)
