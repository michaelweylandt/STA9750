...
```{r}
#| echo: false
anim_save("pre/pa07_ssa.gif")
fs::file_copy("pre/pa07_ssa.gif",
              "docs/pre/pa07_ssa.gif", 
              overwrite=TRUE)
```
...
- DataCamp: "Intermediate Data Visualization with `ggplot2`" and
  "Visualization Best Practices in `R`"
- Textbook: [*R4DS* §29](https://r4ds.hadley.nz/quarto-formats.html) 
