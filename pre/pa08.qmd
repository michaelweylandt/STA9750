...
We are spending three weeks on this topic of "getting data into `R`". Roughly, 
this will break into two sections: 

1) Given a file or a web service designed to share data, 
   how do I get it into `R`? 
2) Given a plain text website, how do I get the text into `R`? Divided further
   into two sections: 
   - How do I get text from the internet into `R`?
   - How do I get numbers and records out of unstructured text?
...
- `readr::read_delim` (read files with an arbitrary delimiter, *e.g.*, 
...
- Textbook: [*R4DS* §7](https://r4ds.hadley.nz/data-import.html) 
  and [*R4DS* §20](https://r4ds.hadley.nz/spreadsheets.html)
