...
2. <a name="gitmisc"></a>
   ...
   6) <a name="gitadd"></a>
      ...
      #00](./mini/mini00.qmd) is helpful, but not
      bullet-proof, here. 
...
The following function will create the GitHub issue necessary to submit a 
mini-project: 
...
#### Verify Mini-Project Submission {#mp_submission_verify}
...
#### Mini-Project Peer Feedback {#mp_pf_perform}

Use the following function to give peer feedback on mini-projects after the 
instructor publishes the peer feedback assignment file in the 
[submission repository](https://github.com/{{< var course.owner >}}/{{< var course.repo >}}).
...
#### Group Project Peer Evaluations {#project_peer_evals}

The following script is used to provide peer feedback at the mid-point and
end-point of the group project: 
...
### Lint Submission {#lint_submission}
