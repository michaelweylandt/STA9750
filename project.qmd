...
::: {.callout-info title="Cross-Section Teams"}
...
On
`{r} DATES |> filter(str_detect(Details, "Mid-Semester Check-In Presentation")) |> pull(Date) |> format("%A %B %d, %Y") |> paste(collapse=" and ")`,
...
highly compelling justification.
