...
-   30% [Mini Projects #01-#04](./miniprojects.html) (Best 3 of 4)
    -   8% per submission
    -   2% per peer feedback (scored *via* meta-review)
-   46% [Course Project](./project.html)
    -   1% Team Contract
    -   5% Proposal
    -   5% Mid-term Check-In
...
::: {.list-table width="1,1,1,1,1,1,1,1" aligns="c,c,l,l,l,l,l,l" header-rows=1 .hover}
   ...
   * - 1
     ...
     - [Mini-Project #00](./mini/mini00.html) assigned. 
   ...
   * - 2
     ...
     - [PA #02](./pre/pa02.html) due at start of class (6:00pm)
   ...
   * - 3
     ...
     - [PA #03](./pre/pa03.html) due at start of class (6:00pm)
     - [Lab #03](./labs/lab03.html)
     - [Mini-Project #00](./mini/mini00.html) due `r due_date_mini(0)`.
     
       [Mini-Project #01](./mini/mini01.html) assigned; due `r due_date_mini(1)`
     - Peer Feedback on Mini Project #00 assigned; 
       due `r due_date_mini(0, feedback=TRUE)`
     - Project Team Rosters due at 6:00pm
   ...
   * - 4
     - `r class_date (04)`
     - <td colspan="4" style="text-align:center"> **In-Class Project Proposal Presentations** <br> *Optional Enrichment Topic: Additional R Basics* </td>
   ...
   * - 5
     ...
     - [PA #05](./pre/pa05.html) due at start of class (6:00pm)
   ...
   * - 6
     ...
     - [PA #06](./pre/pa06.html) due at start of class (6:00pm)
     - [Lab #06](./labs/lab06.html)
     - [Mini-Project #01](./mini/mini01.html) due `r due_date_mini(1)`.
     
       [Mini-Project #02](./mini/mini02.html) assigned. 
   ...
   * - 7
     ...
     - Plotting I:
       ...
       - Maps
     - [PA #07](./pre/pa07.html) due at start of class (6:00pm)
     - [Lab #07](./labs/lab07.html)
     
   * - 8
     - `r class_date (08)`
     <td colspan="5" style="text-align:center"> **Mid-Semester Check-In Presentations** <br> *Optional Enrichment Topic: SQL* </td>
   ...
   * - 
     ...
     - [Mini-Project #02](./mini/mini02.html) due `r due_date_mini(2)`.
     
       [Mini-Project #03](./mini/mini03.html) assigned. 
   ...
   * - 9
     - `r class_date (09)`
     - Data Import
     - [PA #09](./pre/pa09.html) due at start of class (6:00pm)
     - [Lab #09](./labs/lab09.html)
     
     
   * - 10
     - `r class_date (10)` **NB: Tuesday**
     - Tools for Interactive Data Analysis
       - `shiny`
       - `ggplot2` Extensions for Animated and Interactive Plots
     - [PA #10](./pre/pa10.html) due at start of class (6:00pm)
   ...
   * - 11
     ...
     - Elements of Web Scraping
       ...
       - `rvest`
       - JSON
     - [PA #11](./pre/pa11.html) due at start of class (6:00pm)
     - [Lab #11](./labs/lab11.html)
     - [Mini-Project #04](./mini/mini04.html) assigned. 
   ...
   * - 12
     ...
     - [PA #12](./pre/pa12.html) due at start of class (6:00pm)
     - [Lab #12](./labs/lab12.html)
    
   * - 13
     - `r class_date (13)`
     <td colspan="5" style="text-align:center"> **Final Presentations** <br> **Optional Enrichment Topic: Functional Programming in R** </td>
   ...
   * - 14
     ...
     - [PA #14](./pre/pa14.html) due at start of class (6:00pm)
     - [Lab #14](./labs/lab14.html)
     - [Mini-Project #04](./mini/mini04.html) due `r due_date_mini(4)`.
     - Peer Feedback on Mini Project #04 assigned; due 
       `r due_date_mini(4, feedback=TRUE)`
     
   * - 
     - Finals Period
      <td colspan="6" style="text-align:center"> <p>Group Report, Individual Report, Final Peer Evaluations due `r final_report_date()` (Tentatively)</p> </br> <p>Final Grades posted to CUNYFirst by `r final_grades_date()`</p>
::: 
