---
title: "STA 9750 Week 4 In-Class Activity"
format: live-html
engine: knitr
packages:
    - tidyverse
...
filtering on groups and filtering within groups. 
...
were adapted from [the official documentation](https://learnr-examples.shinyapps.io/ex-data-filter/).
